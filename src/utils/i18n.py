...
TRANSLATIONS = {
    "es": {
        ...
        "wake_word_enabled": "Activar por voz",
        "wake_word_enabled_sub": "Permite empezar a dictar diciendo 'Hey Jarvis'",
        "noise_sensitivity": "Sensibilidad al ruido",
        "noise_sensitivity_sub": "Ajuste el filtrado de ruido de fondo constante (como ventiladores) para detectar pausas",
        "noise_low": "Baja (detecta casi todo)",
        "noise_medium": "Media (estándar)",
        "noise_high": "Alta (filtra ruido de ventilador)",
        "noise_highest": "Muy alta (máxima agresividad)",
        "noise_gate": "Umbral de volumen (Puerta de ruido)",
        "noise_gate_sub": "Nivel mínimo de volumen para no considerarlo silencio (ignora ruidos constantes)",
        "noise_gate_low": "Bajo (sala silenciosa: 500)",
        "noise_gate_medium": "Medio (estándar: 1200)",
        "noise_gate_high": "Alto (ventilador moderado: 2000)",
        "noise_gate_highest": "Muy alto (ventilador fuerte: 3000)",
    ...
    "en": {
        ...
        "wake_word_enabled": "Voice Activation",
        "wake_word_enabled_sub": "Allows starting dictation by saying 'Hey Jarvis'",
        "noise_sensitivity": "Noise Sensitivity",
        "noise_sensitivity_sub": "Filter out constant background noise (like fans) to detect pauses",
        "noise_low": "Low (detects almost everything)",
        "noise_medium": "Medium (standard)",
        "noise_high": "High (filters out fan noise)",
        "noise_highest": "Very High (maximum aggressiveness)",
        "noise_gate": "Volume Threshold (Noise Gate)",
        "noise_gate_sub": "Minimum sound level to not consider it silence (ignores constant noise)",
        "noise_gate_low": "Low (quiet room: 500)",
        "noise_gate_medium": "Medium (standard: 1200)",
        "noise_gate_high": "High (moderate fan: 2000)",
        "noise_gate_highest": "Very High (noisy fan: 3000)",
